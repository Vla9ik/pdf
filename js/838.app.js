(self["webpackChunkfls_start"] = self["webpackChunkfls_start"] || []).push([ [ 838 ], {
    2838: function(module) {
            ...
            function createDOMPurify() {
                ...
                var _sanitizeAttributes = function _sanitizeAttributes(currentNode) {
                    ...
                    while (l--) {
                        ...
                        if (trustedTypesPolicy && _typeof(trustedTypes) === "object" && typeof trustedTypes.getAttributeType === "function") if (namespaceURI) ; else switch (trustedTypes.getAttributeType(lcTag, lcName)) {
                          case "TrustedHTML":
                ...
                DOMPurify.sanitize = function(dirty) {
                    ...
                    if (IS_EMPTY_INPUT) dirty = "\x3c!--\x3e";
                    ...
                    if (IN_PLACE) {
                        ...
                        if (importedNode.nodeType === 1 && importedNode.nodeName === "BODY") body = importedNode; else if (importedNode.nodeName === "HTML") body = importedNode; else body.appendChild(importedNode);
                    } else {
